<div class="header-img">
    ...
    <div id="myDropdown" class="dropdown-content">
        ...
        <div class="gallery-link">
            <a href="<?=$view->getThemePath()?>/gallery.html">Zur Galerie</a>
        </div>
    </div>
    ...
    <div class="aboutUs" id="team">
        ...
        <div class="aboutUsContainer">
            <div class="roger">
                <img src="<?=$view->getThemePath()?>/img/Roger.JPG" class= "portrait" alt="Portrait">
                <p class="name">Roger Odermatt</p>
                <p class="personalData">Geschäftsführer / Verkauf</p>
                <a href="<?=$view->getThemePath()?>/mailto:roger.odermatt@shinelight.ch" class="personalData">roger.odermatt@shinelight.ch</a>
                <p class="personalData">041 620 04 00</p>
                <p class="personalData">079 656 25 01</p>
            </div>
            <div class="nirmal">
                <img src="<?=$view->getThemePath()?>/img/Nirmal.png" class= "portrait" alt="Portrait">
                <p class="name">Nirmal Fernando</p>
                <p class="personalData">Einkauf / Auftragsabwicklung</p>
                <a href="<?=$view->getThemePath()?>/mailto:nirmal.fernando@shinelight.ch" class="personalData">nirmal.fernando@shinelight.ch</a>
                <p class="personalData">041 620 04 00</p>
                <p class="personalData">079 333 74 98</p>
            </div>
        </div>
        <div class="agb">
            <a href="<?=$view->getThemePath()?>/img/AGB.pdf">Klicken Sie hier um unsere AGB zu lesen.</a>
        </div>
    </div>
            ...
            <div class="contactData">
                <ul class="contact-methods">
                    ...
                    <li>
                        ...
                        <a href="<?=$view->getThemePath()?>/mailto:info@shinelight.ch">info@shinelight.ch</a>
                    </li>
                </ul>
